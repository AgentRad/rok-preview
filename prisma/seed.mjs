...
const PRODUCTS = [
  ...
  { sku: "CND-ACSR795", name: 'ACSR "Drake" 795 kcmil Overhead Conductor', category: "Conductors & Cable", manufacturer: "Southwire", icon: "cable", price: 4.85, unit: "per ft", etaDays: 10, stock: 24000, supplier: "Ironwood Transmission Supply", specs: { Size: "795 kcmil", Stranding: "26/7 ACSR", Ampacity: "~907 A", Type: "Aluminum conductor, steel-reinforced", Use: "Overhead transmission / distribution" }, description: 'Bare aluminum conductor, steel-reinforced — the workhorse "Drake" conductor for overhead distribution and sub-transmission lines. Cut to length and shipped on returnable reels.' },
